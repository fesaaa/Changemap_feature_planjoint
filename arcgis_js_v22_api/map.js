...
// @formatter:on
        ...
        ready(function () {
            ...
            function initDrawTool() {
                ...
                tbDraw.activate(Draw.POINT);          //Step 2h
            ...
            function populateGrid(results) {
                ...
                dom.byId("divInfo").innerHTML = gridQuakes;
                //console.log(pv_name_th)
                console.log(dataQuakes[0].pv_name_th)
                document.getElementById("divInfo").innerHTML = "<table style='width:500px'> รหัสจังหวัด" + dataQuakes[0].pv_code + "<br>ชื่อจังหวัด" + dataQuakes[0].pv_name_th +"</table>"
                }
