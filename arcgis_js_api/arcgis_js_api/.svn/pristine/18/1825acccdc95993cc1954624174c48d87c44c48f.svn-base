define(["esri/map",
				...
				domConstruct)
	{
		...
		function init(mainView, builder)
		{
			...
			//configOptions.sharingurl = APPCFG.DEFAULT_SHARING_URL;
			configOptions.sharingurl =  "//www.arcgis.com/sharing/content/items";
			...
			esriConfig.defaults.io.proxyUrl = "/sproxy";//configOptions.proxyurl;
			esri.addProxyRule({
	          urlPrefix: "demographics.arcgis.com",
	          proxyUrl: "/sproxy"
	        });   
